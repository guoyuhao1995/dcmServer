...
public class Page implements Serializable{
	 ...
	 *
	 */
	private static final long serialVersionUID = 909149429888778922L;
	//private static final Logger logger = LoggerFactory.getLogger(Page.class);
	private static final Logger logger =LogUtils.INFO;
	...
	public static Page newBuilder(String pageNo, String pageSize) {
		final Page page = new Page();
		if(StringUtils.isBlank(pageNo)){pageNo="1";}
		if(StringUtils.isBlank(pageSize)){pageSize=DEFAULT_PAGESIZE;}
	...
	/**
	 * 计算页号显示样式 这里实现以下的分页样式("[]"代表当前页号)，可根据项目需求调整 &nbsp;&nbsp; *&nbsp;&nbsp; [1],2,3,4,5,6,7,8..12,13 &nbsp;&nbsp; *&nbsp;&nbsp; 1,2..5,6,[7],8,9..12,13 &nbsp;&nbsp; *&nbsp;&nbsp; 1,2..6,7,8,9,10,11,12,[13]
	 */
	...
	public String toString() {
		return "Page [pageNo=" + pageNo + ", pageSize=" + pageSize + ", totalRecord=" + totalRecord + ", totalPage=" + totalPage + ", params="
				+ params + ", paramLists=" + paramLists + ", resultList=" + resultList + ", searchUrl=" + searchUrl + ", pageNoDisp=" + pageNoDisp
				+ "]";
	}
	...
	public static void main(String[] args) {
		...
		page.setPageSize(3);
		page.setPageNo(14);
		page.setTotalRecord(34);
		System.out.println(page.getPageNoDisp());
		System.out.println(page.getSearchUrl());
